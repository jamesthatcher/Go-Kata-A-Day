Feature: Rainfall
  ...
  Scenario Outline: Mean
    ...
    Examples:
      ...
      | "London:Jan 48.0,Feb 38.0,Mar 39.2,Apr 42.2 \n Beijing:Jan 48.0,Feb 38.9,Mar 39.9,Apr 42.2" | "London"       | 41.85        |
      | "Beijing:Jan 98.0,Feb 38.9,Mar 39.9,Apr 42.2 \n London:Jan 68.0,Feb 38.0,Mar 39.2,Apr 42.2" | "Beijing"      | 56.85        |
      | "London:Jan 48.0,Feb 38.0,Mar 39.2,Apr 42.2 \n Beijing:Jan 48.0,Feb 38.9,Mar 39.9,Apr 42.2" | "doesnotexist" | -1           |


  Scenario Outline: Variance
    Given I have data of type <data> and city <city>
    When the variance is calculated
    Then I should have an variance rainfall of <var-rainfall>

    Examples:
      | data                                                                                        | city           | var-rainfall |
      | "London:Jan 48.0,Feb 38.0,Mar 39.2,Apr 42.2 \n Beijing:Jan 48.0,Feb 38.9,Mar 39.9,Apr 42.2" | "London"       | 14.9475      |
      | "Beijing:Jan 58.0,Feb 38.9,Mar 39.9,Apr 42.2 \n London:Jan 48.0,Feb 38.0,Mar 39.2,Apr 42.2" | "Beijing"      | 51.4475      |
      | "London:Jan 48.0,Feb 38.0,Mar 39.2,Apr 42.2 \n Beijing:Jan 48.0,Feb 38.9,Mar 39.9,Apr 42.2" | "doesnotexist" | -1           |
