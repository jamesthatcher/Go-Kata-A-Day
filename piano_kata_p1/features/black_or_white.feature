Feature: Black or white
  ...
  just not possible) and return the string "black" or "white"

  Scenario Outline: Black or white
    Given I stopped at <key>
    Then it should return the <colour> of the <key>
